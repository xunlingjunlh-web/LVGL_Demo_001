...
lv_obj_t * ui_Screen_2_Move = NULL;
...
lv_obj_t * ui_BTN_Menu_Print_S2 = NULL;
lv_obj_t * ui_BTN_Menu_Move_S2 = NULL;
lv_obj_t * ui_BTN_Menu_Setting_S2 = NULL;
lv_obj_t * ui_S1_Content_Panel1 = NULL;
lv_obj_t * ui_Display_Pos_XY = NULL;
lv_obj_t * ui_DP1 = NULL;
lv_obj_t * ui_Label_X_Position = NULL;
lv_obj_t * ui_Label_X_Position_Number = NULL;
lv_obj_t * ui_Panel2 = NULL;
lv_obj_t * ui_DP2 = NULL;
lv_obj_t * ui_Label_Y_Position = NULL;
lv_obj_t * ui_Label_Time_3 = NULL;
lv_obj_t * ui_Display_Pos_y = NULL;
lv_obj_t * ui_DP3 = NULL;
lv_obj_t * ui_Label_Z_Position = NULL;
lv_obj_t * ui_Label_Z_Position_Number = NULL;
lv_obj_t * ui_BTN_Move_Z = NULL;
lv_obj_t * ui_GLOW_1 = NULL;
lv_obj_t * ui_GLOW_2 = NULL;
lv_obj_t * ui_BTN_Image_Top = NULL;
lv_obj_t * ui_Label_Z_Position_2 = NULL;
lv_obj_t * ui_Arrow_Z_up = NULL;
lv_obj_t * ui_Arrow_Z_Down = NULL;
lv_obj_t * ui_BTN_Move_XY = NULL;
lv_obj_t * ui_GLOW_3 = NULL;
lv_obj_t * ui_GLOW_4 = NULL;
lv_obj_t * ui_GLOW_5 = NULL;
lv_obj_t * ui_GLOW_6 = NULL;
lv_obj_t * ui_BTN_Move_XY_Top = NULL;
lv_obj_t * ui_Label_XY_Position = NULL;
lv_obj_t * ui_Arrow_Up_2 = NULL;
lv_obj_t * ui_Arrow_Down_2 = NULL;
lv_obj_t * ui_Arrow_Left_2 = NULL;
lv_obj_t * ui_Arrow_Right_2 = NULL;
lv_obj_t * ui_Roller_Number = NULL;
lv_obj_t * ui_Image8 = NULL;
lv_obj_t * ui_Roller1 = NULL;
lv_obj_t * ui_Label_Steps = NULL;
lv_obj_t * ui_BTN_Reset = NULL;
lv_obj_t * ui_Label_Reset = NULL;
lv_obj_t * ui_BTN_Heat = NULL;
...
void ui_Screen_2_Move_screen_destroy(void)
{
    if(ui_Screen_2_Move) lv_obj_del(ui_Screen_2_Move);

    // NULL screen variables
    ui_Screen_2_Move = NULL;
    ui_Background1 = NULL;
    ...
    ui_IMG_PC1 = NULL;
    ui_IMG_USB1 = NULL;
    ui_BTN_Menu_Print_S2 = NULL;
    ui_BTN_Menu_Move_S2 = NULL;
    ui_BTN_Menu_Setting_S2 = NULL;
    ui_S1_Content_Panel1 = NULL;
    ui_Display_Pos_XY = NULL;
    ui_DP1 = NULL;
    ui_Label_X_Position = NULL;
    ui_Label_X_Position_Number = NULL;
    ui_Panel2 = NULL;
    ui_DP2 = NULL;
    ui_Label_Y_Position = NULL;
    ui_Label_Time_3 = NULL;
    ui_Display_Pos_y = NULL;
    ui_DP3 = NULL;
    ui_Label_Z_Position = NULL;
    ui_Label_Z_Position_Number = NULL;
    ui_BTN_Move_Z = NULL;
    ui_GLOW_1 = NULL;
    ui_GLOW_2 = NULL;
    ui_BTN_Image_Top = NULL;
    ui_Label_Z_Position_2 = NULL;
    ui_Arrow_Z_up = NULL;
    ui_Arrow_Z_Down = NULL;
    ui_BTN_Move_XY = NULL;
    ui_GLOW_3 = NULL;
    ui_GLOW_4 = NULL;
    ui_GLOW_5 = NULL;
    ui_GLOW_6 = NULL;
    ui_BTN_Move_XY_Top = NULL;
    ui_Label_XY_Position = NULL;
    ui_Arrow_Up_2 = NULL;
    ui_Arrow_Down_2 = NULL;
    ui_Arrow_Left_2 = NULL;
    ui_Arrow_Right_2 = NULL;
    ui_Roller_Number = NULL;
    ui_Image8 = NULL;
    ui_Roller1 = NULL;
    ui_Label_Steps = NULL;
    ui_BTN_Reset = NULL;
