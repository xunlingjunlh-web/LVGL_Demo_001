...
lv_obj_t * ui_Screen_3_Setting = NULL;
lv_obj_t * ui_Background2 = NULL;
lv_obj_t * ui_Panel_Header2 = NULL;
lv_obj_t * ui_Label_Header2 = NULL;
lv_obj_t * ui_IMG_Wifi2 = NULL;
lv_obj_t * ui_IMG_PC2 = NULL;
lv_obj_t * ui_IMG_USB2 = NULL;
lv_obj_t * ui_BTN_Menu_Print_S3 = NULL;
lv_obj_t * ui_BTN_Menu_Move_S3 = NULL;
lv_obj_t * ui_BTN_Menu_Setting_S3 = NULL;
lv_obj_t * ui_S1_Content_Panel2 = NULL;
lv_obj_t * ui_Roller_Material = NULL;
lv_obj_t * ui_Image3 = NULL;
lv_obj_t * ui_Roller4 = NULL;
lv_obj_t * ui_Label_Material = NULL;
lv_obj_t * ui_Roller_Bed_Temp = NULL;
lv_obj_t * ui_Image2 = NULL;
lv_obj_t * ui_Roller3 = NULL;
lv_obj_t * ui_Label_Bed_Temp1 = NULL;
lv_obj_t * ui_Roller_Head_Temp = NULL;
lv_obj_t * ui_Image1 = NULL;
lv_obj_t * ui_Roller2 = NULL;
lv_obj_t * ui_Label_Head_Temp1 = NULL;
lv_obj_t * ui_BTN_Heat_Head = NULL;
lv_obj_t * ui_Label_Reset22 = NULL;
lv_obj_t * ui_BTN_Heat_Bed = NULL;
lv_obj_t * ui_Label_Heat_Bed = NULL;
lv_obj_t * ui_BTN_Remove_Filament = NULL;
lv_obj_t * ui_Label_Remove_Filament = NULL;
lv_obj_t * ui_Panel_Slider = NULL;
lv_obj_t * ui_Slider_Print_Speed = NULL;
lv_obj_t * ui_Label_Print_Speed = NULL;
lv_obj_t * ui_Label_Print_Speed_Number = NULL;
lv_obj_t * ui_Swich_Group = NULL;
lv_obj_t * ui_Label_Light = NULL;
lv_obj_t * ui_Switch_Light = NULL;
lv_obj_t * ui_Label_Fan_1 = NULL;
lv_obj_t * ui_Switch_Fan_1 = NULL;
lv_obj_t * ui_Label_Fan_2 = NULL;
lv_obj_t * ui_Switch_Fan_2 = NULL;
lv_obj_t * ui_Label_Fan_3 = NULL;
lv_obj_t * ui_Switch_Fan_3 = NULL;
// event funtions
...
void ui_Screen_3_Setting_screen_destroy(void)
{
    if(ui_Screen_3_Setting) lv_obj_del(ui_Screen_3_Setting);

    // NULL screen variables
    ui_Screen_3_Setting = NULL;
    ui_Background2 = NULL;
    ...
    ui_BTN_Menu_Move_S3 = NULL;
    ui_BTN_Menu_Setting_S3 = NULL;
    ui_S1_Content_Panel2 = NULL;
    ui_Roller_Material = NULL;
    ui_Image3 = NULL;
    ui_Roller4 = NULL;
    ui_Label_Material = NULL;
    ui_Roller_Bed_Temp = NULL;
    ui_Image2 = NULL;
    ui_Roller3 = NULL;
    ui_Label_Bed_Temp1 = NULL;
    ui_Roller_Head_Temp = NULL;
    ui_Image1 = NULL;
    ui_Roller2 = NULL;
    ui_Label_Head_Temp1 = NULL;
    ui_BTN_Heat_Head = NULL;
    ui_Label_Reset22 = NULL;
    ui_BTN_Heat_Bed = NULL;
    ui_Label_Heat_Bed = NULL;
    ui_BTN_Remove_Filament = NULL;
    ui_Label_Remove_Filament = NULL;
    ui_Panel_Slider = NULL;
    ui_Slider_Print_Speed = NULL;
    ui_Label_Print_Speed = NULL;
    ui_Label_Print_Speed_Number = NULL;
    ui_Swich_Group = NULL;
    ui_Label_Light = NULL;
    ui_Switch_Light = NULL;
    ui_Label_Fan_1 = NULL;
    ui_Switch_Fan_1 = NULL;
    ui_Label_Fan_2 = NULL;
    ui_Switch_Fan_2 = NULL;
    ui_Label_Fan_3 = NULL;
    ui_Switch_Fan_3 = NULL;
