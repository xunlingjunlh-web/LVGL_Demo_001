...
lv_obj_t * ui_IMG_Wifi = NULL;
lv_obj_t * ui_IMG_PC = NULL;
lv_obj_t * ui_IMG_USB = NULL;
...
lv_obj_t * ui_Slider_Print_View = NULL;
lv_obj_t * ui_Number_Print = NULL;
lv_obj_t * ui_Display_Time_S1 = NULL;
lv_obj_t * ui_DT1 = NULL;
lv_obj_t * ui_Label_Printing_Time_1 = NULL;
lv_obj_t * ui_IMG_Tine_1 = NULL;
lv_obj_t * ui_Label_Time_1 = NULL;
lv_obj_t * ui_Panel3 = NULL;
lv_obj_t * ui_DT2 = NULL;
lv_obj_t * ui_Label_Printing_Time_2 = NULL;
lv_obj_t * ui_IMG_Tine_2 = NULL;
lv_obj_t * ui_Label_Time_2 = NULL;
lv_obj_t * ui_Display_Heat_S1 = NULL;
lv_obj_t * ui_DT3 = NULL;
lv_obj_t * ui_Label_Printing_Head_Temp = NULL;
lv_obj_t * ui_IMG_Head = NULL;
lv_obj_t * ui_Label_Head_Temp = NULL;
lv_obj_t * ui_Label_Printing_Head_Temp_2 = NULL;
lv_obj_t * ui_Panel1 = NULL;
lv_obj_t * ui_DT3_copy = NULL;
lv_obj_t * ui_Label_Printing_Bed_Temp = NULL;
lv_obj_t * ui_IMG_Head1 = NULL;
lv_obj_t * ui_Label_Bed_Temp = NULL;
lv_obj_t * ui_Label_Printing_Bed_Temp1 = NULL;
lv_obj_t * ui_Panel_Buttons_S1 = NULL;
lv_obj_t * ui_BTN_Pause = NULL;
...
void ui_Screen_1_Print_screen_destroy(void)
{
    ...
    ui_Slider_Print_View = NULL;
    ui_Number_Print = NULL;
    ui_Display_Time_S1 = NULL;
    ui_DT1 = NULL;
    ui_Label_Printing_Time_1 = NULL;
    ui_IMG_Tine_1 = NULL;
    ui_Label_Time_1 = NULL;
    ui_Panel3 = NULL;
    ui_DT2 = NULL;
    ui_Label_Printing_Time_2 = NULL;
    ui_IMG_Tine_2 = NULL;
    ui_Label_Time_2 = NULL;
    ui_Display_Heat_S1 = NULL;
    ui_DT3 = NULL;
    ui_Label_Printing_Head_Temp = NULL;
    ui_IMG_Head = NULL;
    ui_Label_Head_Temp = NULL;
    ui_Label_Printing_Head_Temp_2 = NULL;
    ui_Panel1 = NULL;
    ui_DT3_copy = NULL;
    ui_Label_Printing_Bed_Temp = NULL;
    ui_IMG_Head1 = NULL;
    ui_Label_Bed_Temp = NULL;
